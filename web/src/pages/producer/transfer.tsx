...
export default function TransferProductsPage() {
  ...
  const loadProducts = async () => {
    setIsLoading(true);
    try {
      console.log('🔄 Cargando productos disponibles para transferir...');
      ...
      if (productsResponse.success && productsResponse.data) {
        ...
        setProducts([]);
        toast.info('No hay productos disponibles para transferir');
      }
  ...
  const handleTransferComplete = (product: Product, toRole: UserRole, recipient: any) => {
    ...
    toast.success(`Producto "${product.name}" transferido exitosamente a ${recipient.name}`);
  ...
  if (isLoading) {
    return (
      <>
        <Head>
          <title>Transferir Productos - Food Traceability</title>
          <meta name="description" content="Transferir productos a otros actores de la cadena de suministro" />
        </Head>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600">Obteniendo productos disponibles para transferir...</p>
          </div>
        </div>
      </>
    );
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-lg font-semibold text-gray-900">Transferir Productos</h1>
                    <p className="text-sm text-gray-500">Envía productos a procesadores y distribuidores</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Selecciona los productos que deseas transferir a procesadores, distribuidores o minoristas.
                Solo se muestran productos activos y no vencidos.
              </p>
            </div>
            ...
            <div className="card">
              ...
              {filteredProducts.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No hay productos para transferir</h3>
                  <p className="text-gray-600 mb-4">
                    {searchTerm ? 'No se encontraron productos con ese término' : 'No tienes productos activos disponibles para transferir'}
                  </p>
