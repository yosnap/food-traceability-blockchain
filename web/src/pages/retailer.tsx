            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="card">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">Vendidos Hoy</p>
                    <p className="text-2xl font-semibold text-gray-900">{stats.soldToday}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
              <div className="card hover:shadow-lg transition-shadow cursor-pointer">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Vender productos a consumidores finales</p>
                </div>
              </div>
              ...
              <div className="card hover:shadow-lg transition-shadow cursor-pointer">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestionar Precios</h3>
