 ...
 * Incluye gestión de solicitudes y notificaciones
 */
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success) {
                    ...
                    const todayRequests = data.requests.filter((req: any) => 
                        new Date(req.requestedAt).toDateString() === today
                    ).length;

                    setStats({
                        pendingRequests: data.count || 0,
                        totalUsers: 0, // Esto se podría obtener de otra API
                        todayRequests
                    });
                }
            }
                    ...
                    <div className="px-4 py-6">
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <p className="text-gray-500">
                                Esta sección permitirá gestionar usuarios existentes, 
                                revocar accesos, y administrar certificados.
                            </p>
                            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                <p className="text-sm text-blue-800">
                                    <strong>Próximamente:</strong> Panel completo de gestión de usuarios
                                </p>
                            </div>
                        </div>
                    </div>
